...
manageProjects.getProjects()[0].createTask('1 One Task TODAY THIS WEEK HIGH', 1, 1, 'desc',0);
manageProjects.getProjects()[0].createTask('1 Two Task HIGH', -1,1, 'desc', 0);
...
manageProjects.getProjects()[1].createTask('2 One Task THIS WEEK HIGH', 2, 1, 'desc',1);
...
manageProjects.getProjects()[2].createTask('3 Two Task HIGH', -1, 1,'desc',2);
